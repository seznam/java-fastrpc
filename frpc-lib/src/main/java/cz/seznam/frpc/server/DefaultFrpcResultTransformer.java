 ...
 * {@code Map} which includes additional information like status code and status message.
 *
 * @author David Moidl david.moidl@firma.seznam.cz
 */
public class DefaultFrpcResultTransformer implements FrpcResultTransformer<Map<String, Object>> {
